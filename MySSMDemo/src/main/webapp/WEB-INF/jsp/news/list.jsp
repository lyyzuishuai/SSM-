...
<div class="screen">
    ...
    <div class="s_show">
        <div class="magictime twisterInUp">会员特惠月开始了</div>
        <div class="magictime twisterInUp">迎双旦促销大酬宾</div>
        <div class="magictime twisterInUp">
            会员特惠月开始了,亲们赶快下单啊,不到剁手誓不罢休啊,不到离婚誓不清空购物车啊。更多优惠，尽在易买网。
        </div>
        <div class="magictime twisterInUp">迎双旦促销大酬宾</div>
        <div class="magictime twisterInUp">积分兑换开始了</div>
        <div class="magictime twisterInUp">加入会员，赢千万大礼包3</div>
        <div class="magictime twisterInUp">迎双旦促销大酬宾</div>
        <div class="magictime twisterInUp">新年不夜天，通宵也是开张了41</div>
        <div class="magictime twisterInUp">会员特惠月开始了111</div>
        <div class="magictime twisterInUp">会员特惠月开始了</div>
        <div class="magictime twisterInUp">迎双旦促销大酬宾</div>
        <div class="magictime twisterInUp">
            会员特惠月开始了,亲们赶快下单啊,不到剁手誓不罢休啊,不到离婚誓不清空购物车啊。更多优惠，尽在易买网。
