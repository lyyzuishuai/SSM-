                ...
                <ul>
                    ...
                    <li class="submenu active"><a href="#"><i
                        ...
                        <ul>
                            ...
                            <li><a href="list" class="active">分类管理</a></li>
                            ...
                            <table class="table table-hover table-center mb-0 datatable">
                                ...
                                <c:forEach items="${categories}" var="categorie">
                                    <tr>
                                        ...
                                        <td>${categorie.parentid}</td>
                                        <td>${categorie.parentName}</td>
                                        <td>${categorie.type}</td>
                                        <td class="text-right">
                                            <div class="actions"><a
                                                    href="/manage/category/category/returnCategoryEditPage?id=${categorie.id}"
                                                    class="btn btn-sm bg-success-light mr-2"><i
                                                    class="fas fa-pen"></i></a><a href="#"
                                                                                  onclick="deleteByCategoryId(${categorie.id})"
...
<script>
    function getPage(pageNo) {
        ...
        var url = "${pageContext.request.contextPath}/manage/category/list?pageNo=" + pageNo + "&pageSize=" + pageSize;
        //判断是否选择了分类级别
        if ($("#type").val() != 0) {
            url += "&type=" + $("#type").val();
        }
...
<script>
    ...
    function deleteByCategoryId(id) {
        if (confirm('确实要删除吗?')) {
            $.ajax({
                url: "/manage/category/category/deleteProductById",
                type: "get",
                data: {"id": id},
                dataType: 'json',
