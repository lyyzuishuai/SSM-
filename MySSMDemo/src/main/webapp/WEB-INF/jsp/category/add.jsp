        ...
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                ...
                <li class="submenu active"><a href="#"><i
                        ...
                        class="menu-arrow"></span></a>
                    <ul>
                        <li><a href="list" class="active">新增分类</a></li>
...
<div class="row">
    <div class="col-sm-12">
        ...
        <div class="card-body">
            <div class="card-title"><h3 class="text-center title-2">分类信息</h3>
            </div>
            <form action="${pageContext.request.contextPath}/manage/category/save" method="post">
                <div class="form-group">
                    <label for="name">名称</label>
                    <%--                    <input id="name" name="name" type="text" class="form-control" placeholder="分类">--%>
                ...
                <div class="form-group">
                    <label for="parentid">父级目录id</label>
                    <select name="parentid" class="form-control">
                        <c:forEach items="${category}" var="ca">
                            <option value="${ca.parentid}">${ca.parentid}</option>
                        </c:forEach>
                    </select>
                </div>
                <div class="form-group">
                    ...
                    <select name="parentName" class="form-control">
                        <c:forEach items="${category}" var="ca">
                            <option value="${ca.parentName}">${ca.parentName}</option>
                        </c:forEach>
                    </select>
                    <%--                    <input id="parentName" name="parentName" type="text"--%>
                    <%--                           class="form-control" placeholder="父级">--%>
                </div>
                <div class="form-group">
                    <label for="type">父级类别</label>
                    <input id="type" name="type" type="number"
                           class="form-control" placeholder="父类级别">
                </div>
