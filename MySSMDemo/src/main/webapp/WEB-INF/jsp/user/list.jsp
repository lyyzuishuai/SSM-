...
<div class="main-wrapper"><!-- Header -->
            ...
            <div id="sidebar-menu" class="sidebar-menu">
                <ul>
                    ...
                    <li class="submenu active"><a href="#"><i
                            class="fas fa-user-graduate"></i><span>用户管理</span><span
                            class="menu-arrow"></span></a>
                        <ul>
                            <li><a href="/manage/user/add">新增用户</a></li>
                            <li><a href="list" class="active">用户管理</a></li>
    ...
    <div class="page-wrapper">
        <div class="content container-fluid"><!-- Page Header -->
            <div class="bbn">
                <div id="main">
                    <div id="boxID"><!--焦点图盒子-->
                        <div class="pic"><!--内容列表(li数目可随意增减)，class="pic"不要变-->
                            <ul>
                                <li><a href="#"><img class="pics" src="../../../assets4/img/6.jpg" alt="你"/></a>
                                </li>
                                <li><a href="#"><img class="pics" src="../../../assets4/img/7.jpg" alt="干"/></a>
                                </li>
                                <li><a href="#"><img class="pics" src="../../../assets4/img/8.jpg" alt="嘛"/></a>
                                </li>
                                <li><a href="#"><img class="pics" src="../../../assets4/img/9.png" alt="哎"/></a>
                                </li>
                                <li><a href="#"><img class="pics" src="../../../assets4/img/10.png" alt="哟"/></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="bvn">
                    <div id="header" class="top-nav-search">
                        <form class="form">
                            ...
                            <button type="button" class="btn" onclick="getPage(1)"><i style="transform: translateY(6px)"
                            ...
                            <table class="table table-hover table-center mb-0 datatable">
                                ...
                                <c:forEach items="${users}" var="user">
                                    <tr>
                                        ...
                                        <td>${user.type}</td>
                                        <td class="text-right">
                                            <div class="actions"><a href="/user/returnUserEditPage?id=${user.id}"
    ...
    <script>
        function getPage(pageNo) {
            ...
            var url = "${pageContext.request.contextPath}/manage/user/list?pageNo=" + pageNo + "&pageSize=" + pageSize;
            //判断是否选择了分类级别
            if ($("#type").val() != 0) {
                url += "&type=" + $("#type").val();
            }
