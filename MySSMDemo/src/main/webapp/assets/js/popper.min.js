(function (a, b) {
    ...
    function aL(a, d) {
        ...
        return parseFloat(a["border" + c + "Width"]) + parseFloat(a["border" + b + "Width"])
    }
    ...
    function a8(g) {
        ...
        var r = {left: q.left, top: q.top, width: q.right - q.left, height: q.bottom - q.top},
            v = "HTML" === g.nodeName ? ai(g.ownerDocument) : {}, c = v.width || g.clientWidth || r.width,
            b = v.height || g.clientHeight || r.height, j = g.offsetWidth - c, k = g.offsetHeight - b;
        if (j || k) {
            var x = w(g);
    ...
    function ag(n, v) {
        var r = 2 < arguments.length && void 0 !== arguments[2] && arguments[2], x = aZ(10), z = "HTML" === v.nodeName,
            k = a8(n), f = a8(v), t = aO(n), u = a5(v), q = parseFloat(u.borderTopWidth),
            j = parseFloat(u.borderLeftWidth);
        ...
        if (g.marginTop = 0, g.marginLeft = 0, !x && z) {
            var A = parseFloat(u.marginTop), B = parseFloat(u.marginLeft);
    ...
    function ba(b, x, q, o) {
        var w = 4 < arguments.length && void 0 !== arguments[4] && arguments[4], a = {top: 0, left: 0},
            k = w ? ap(b) : ac(b, aB(x));
        if ("viewport" === o) {
            a = bc(k, w)
        } else {
            var c;
            "scrollParent" === o ? (c = aO(aR(x)), "BODY" === c.nodeName && (c = b.ownerDocument.documentElement)) : "window" === o ? c = b.ownerDocument.documentElement : c = o;
            var n = ag(c, k, w);
            if ("HTML" === c.nodeName && !bg(k)) {
                var j = ai(b.ownerDocument), i = j.height, y = j.width;
                a.top += n.top - n.marginTop, a.bottom = i + n.top, a.left += n.left - n.marginLeft, a.right = y + n.left
            } else {
                a = n
            }
        }
        ...
        return a.left += z ? q : q.left || 0, a.top += z ? q : q.top || 0, a.right -= z ? q : q.right || 0, a.bottom -= z ? q : q.bottom || 0, a
    }
    ...
    function aJ(a, f, c) {
        var b = 3 < arguments.length && void 0 !== arguments[3] ? arguments[3] : null, d = b ? ap(f) : ac(f, aB(c));
        return ag(c, d, b)
    }
    ...
    function aG() {
        if (!this.state.isDestroyed) {
            ...
            a.offsets.reference = aJ(this.state, this.popper, this.reference, this.options.positionFixed), a.placement = aS(this.options.placement, a.offsets.reference, this.popper, this.reference, this.options.modifiers.flip.boundariesElement, this.options.modifiers.flip.padding), a.originalPlacement = a.placement, a.positionFixed = this.options.positionFixed, a.offsets.popper = aj(this.popper, a.offsets.reference, a.placement), a.offsets.popper.position = this.options.positionFixed ? "fixed" : "absolute", a = aV(this.modifiers, a), this.state.isCreated ? this.options.onUpdate(a) : (this.state.isCreated = !0, this.options.onCreate(a))
        }
    }
    ...
    function bb(a, b) {
        Object.keys(b).forEach(function (d) {
            var c = "";
            -1 !== ["width", "height", "top", "right", "bottom", "left"].indexOf(d) && bh(b[d]) && (c = "px"), a.style[d] = b[d] + c
        })
    }
    ...
    function aX(g, z) {
        var v = g.offsets, u = v.popper, j = v.reference, x = aa, w = function (a) {
            ...
            k = -1 !== g.placement.indexOf("-"), h = z ? b || k || y % 2 == c % 2 ? x : bj : w, q = z ? x : w;
        return {
    ...
    function aw(a) {
        var d = 1 < arguments.length && void 0 !== arguments[1] && arguments[1], c = aA.indexOf(a),
    ...
    function aF(b, l) {
        ...
        return g = bh(+f) ? [+f, 0] : bf(f, h, k, a), "left" === a ? (h.top += g[0], h.left -= g[1]) : "right" === a ? (h.top += g[0], h.left += g[1]) : "top" === a ? (h.left += g[0], h.top -= g[1]) : "bottom" === a && (h.left += g[0], h.top += g[1]), b.popper = h, b
    }

    var aY = Math.min, bj = Math.floor, aa = Math.round, aq = Math.max,
        a7 = "undefined" != typeof window && "undefined" != typeof document && "undefined" != typeof navigator,
        aT = function () {
            ...
            return 0
        }(), aQ = a7 && window.Promise, aD = aQ ? function (a) {
            var b = !1;
            return function () {
        ...
        aW = a7 && /MSIE 10/.test(navigator.userAgent), a4 = function (a, b) {
            if (!(a instanceof b)) {
        ...
        aN = ["auto-start", "auto", "auto-end", "top-start", "top", "top-end", "right-start", "right", "right-end", "bottom-end", "bottom", "bottom-start", "left-end", "left", "left-start"],
        aA = aN.slice(3), ak = {FLIP: "flip", CLOCKWISE: "clockwise", COUNTERCLOCKWISE: "counterclockwise"},
        ax = function () {
            function a(d, c) {
                var b = this, f = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : {};
                a4(this, a), this.scheduleUpdate = function () {
                    return requestAnimationFrame(b.update)
                }, this.update = aD(this.update.bind(this)), this.options = aK({}, a.Defaults, f), this.state = {
                    isDestroyed: !1,
                    isCreated: !1,
                    scrollParents: []
                }, this.reference = d && d.jquery ? d[0] : d, this.popper = c && c.jquery ? c[0] : c, this.options.modifiers = {}, Object.keys(aK({}, a.Defaults.modifiers, f.modifiers)).forEach(function (g) {
                    b.options.modifiers[g] = aK({}, a.Defaults.modifiers[g] || {}, f.modifiers ? f.modifiers[g] : {})
    ...
    return ax.Utils = ("undefined" == typeof window ? global : window).PopperUtils, ax.placements = aN, ax.Defaults = {
        placement: "bottom", positionFixed: !1, eventsEnabled: !0, removeOnDestroy: !1, onCreate: function () {
                ...
                order: 100, enabled: !0, fn: function (f) {
                    ...
                    if (j) {
                        var g = f.offsets, q = g.reference, m = g.popper, u = -1 !== ["bottom", "top"].indexOf(k),
                            ...
                            h = {start: af({}, c, q[c]), end: af({}, c, q[c] + q[b] - m[b])};
            ...
            preventOverflow: {
                order: 300, enabled: !0, fn: function (g, x) {
                    ...
                    var q = ah("transform"), j = g.instance.popper.style, v = j.top, w = j.left, c = j[q];
                    j.top = "", j.left = "", j[q] = "";
                    var b = ba(g.instance.popper, g.instance.reference, x.padding, u, g.positionFixed);
                    j.top = v, j.left = w, j[q] = c, x.boundaries = b;
                    var k = x.priority, h = g.offsets.popper, p = {
                        primary: function (a) {
                            var d = h[a];
                            return h[a] < b[a] && !x.escapeWithReference && (d = aq(h[a], b[a])), af({}, a, d)
                        }, secondary: function (a) {
                            var f = "right" === a ? "left" : "top", d = h[f];
                            return h[a] > b[a] && !x.escapeWithReference && (d = aY(h[f], b[a] - ("right" === a ? h.width : h.height))), af({}, f, d)
                        }
                    };
            ...
            keepTogether: {
                order: 400, enabled: !0, fn: function (f) {
                    var q = f.offsets, j = q.popper, h = q.reference, g = f.placement.split("-")[0], l = bj,
            ...
            arrow: {
                order: 500, enabled: !0, fn: function (t, G) {
                    ...
                    var j = q[D] + q[C] / 2 - K / 2, M = a5(t.instance.popper), N = parseFloat(M["margin" + z]),
                        x = parseFloat(M["border" + z + "Width"]), L = j - t.offsets.popper[D] - N - x;
                    return L = aq(aY(J[C] - K, L), 0), t.arrowElement = B, t.offsets.arrow = (F = {}, af(F, D, aa(L)), af(F, A, ""), F), t
                }, element: "[x-arrow]"
            },
            flip: {
                order: 600,
                ...
                fn: function (a, h) {
                    ...
                    var d = ba(a.instance.popper, a.instance.reference, h.padding, h.boundariesElement, a.positionFixed),
                    ...
                    return f.forEach(function (x, k) {
                        if (c !== x || f.length === k + 1) {
                            return a
                        }
                        c = a.placement.split("-")[0], b = a6(c);
                        var e = a.offsets.popper, r = a.offsets.reference, o = bj,
                            t = "left" === c && o(e.right) > o(r.left) || "right" === c && o(e.left) < o(r.right) || "top" === c && o(e.bottom) > o(r.top) || "bottom" === c && o(e.top) < o(r.bottom),
                            q = o(e.left) < o(d.left), j = o(e.right) > o(d.right), p = o(e.top) < o(d.top),
                            z = o(e.bottom) > o(d.bottom),
                            i = "left" === c && q || "right" === c && j || "top" === c && p || "bottom" === c && z,
                            B = -1 !== ["top", "bottom"].indexOf(c),
                            C = !!h.flipVariations && (B && "start" === g && q || B && "end" === g && j || !B && "start" === g && p || !B && "end" === g && z),
                            n = !!h.flipVariationsByContent && (B && "start" === g && j || B && "end" === g && q || !B && "start" === g && z || !B && "end" === g && p),
                            A = C || n;
                        (t || i || A) && (a.flipped = !0, (t || i) && (c = f[k + 1]), A && (g = bi(g)), a.placement = c + (g ? "-" + g : ""), a.offsets.popper = aK({}, a.offsets.popper, aj(a.instance.popper, a.offsets.reference, a.placement)), a = aV(a.instance.modifiers, a, "flip"))
                    }), a
                },
                behavior: "flip",
                padding: 5,
            ...
            hide: {
                order: 800, enabled: !0, fn: function (a) {
                    ...
                    var c = a.offsets.reference, b = am(a.instance.modifiers, function (d) {
            ...
            computeStyle: {
                order: 850, enabled: !0, fn: function (u, J) {
                    var G = J.x, F = J.y, B = u.offsets.popper, H = am(u.instance.modifiers, function (a) {
                    ...
                    var I, q, j = void 0 === H ? J.gpuAcceleration : H, C = aU(u.instance.popper), x = a8(C),
                        D = {position: B.position}, A = aX(u, 2 > window.devicePixelRatio || !au),
                    ...
                    return u.attributes = aK({}, v, u.attributes), u.styles = aK({}, D, u.styles), u.arrowStyles = aK({}, u.offsets.arrow, u.arrowStyles), u
                }, gpuAcceleration: !0, x: "bottom", y: "right"
            },
            applyStyle: {
                order: 900, enabled: !0, fn: function (a) {
                    return bb(a.instance.popper, a.styles), aE(a.instance.popper, a.attributes), a.arrowElement && Object.keys(a.arrowStyles).length && bb(a.arrowElement, a.arrowStyles), a
                    ...
                    return h.setAttribute("x-placement", f), bb(h, {position: d.positionFixed ? "fixed" : "absolute"}), d
